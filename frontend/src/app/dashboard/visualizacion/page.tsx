...
export default function VisualizacionPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="font-display text-2xl font-bold tracking-tight text-slate-900">Visualización de Datos</h1>
        <p className="text-sm text-muted-foreground mt-0.5">
          Exploración de compuestos a lo largo del proceso de fermentación
        </p>
      </div>
      ...
      <Card className="border-slate-100">
        <CardHeader>
          <CardTitle className="font-display">Evolución de Compuestos (g/L)</CardTitle>
